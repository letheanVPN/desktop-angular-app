## @dappserver/server-sdk-angular@3.1.0
...
```
npm install @dappserver/server-sdk-angular@3.1.0 --save
```
...
In your project:
```
npm link @dappserver/server-sdk-angular
```
...
import { serverSDKApiModule } from '@dappserver/server-sdk-angular';
...
import { serverSDKApiModule, serverSDKConfiguration, serverSDKConfigurationParameters } from '@dappserver/server-sdk-angular';
...
import { serverSDKApiModule, serverSDKConfiguration } from '@dappserver/server-sdk-angular';
...
```
import { DefaultApi } from '@dappserver/server-sdk-angular';
...
```
import { BASE_PATH } from '@dappserver/server-sdk-angular';
