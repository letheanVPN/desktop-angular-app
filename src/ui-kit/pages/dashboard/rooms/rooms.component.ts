...
@Component({
  ...
  template: `
    <nb-card [size]="breakpoint.width >= breakpoints.sm ? 'giant' : ''">
      ...
      <lthn-ui-room-selector [class.dark-background]="isDarkTheme" (selectEvent)="select($event)"></lthn-ui-room-selector>
      <lthn-ui-player [collapsed]="isCollapsed() && breakpoint.width <= breakpoints.md"></lthn-ui-player>
    </nb-card>
  `,
})
